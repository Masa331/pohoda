    ...
    module Ord
      class OrderSummaryType
        ...
        def builder
          ...
          root << build_element('ord:roundingDocument', data[:rounding_document]) if data.key? :rounding_document
          root << build_element('ord:roundingVAT', data[:rounding_vat]) if data.key? :rounding_vat
