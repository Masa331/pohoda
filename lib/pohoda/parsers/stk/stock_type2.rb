    ...
    module Stk
      class StockType2
        ...
        def to_h
          ...
          hash[:action_type] = action_type if has? 'stk:actionType'
          hash[:action_type_attributes] = action_type_attributes if has? 'stk:actionType'
